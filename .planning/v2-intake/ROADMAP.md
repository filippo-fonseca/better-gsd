...
- [ ] **Phase E1: NL/Voice Intake → Rich Intent Spec** - NL/voice description → Haiku spec-gen → a large, chunked, indexed Markdown intent spec, fed into `gsd-new-project` through the seam
...
|-------|----------------|--------|-----------|
| E1. NL/Voice Intake → Rich Intent Spec | 0/1 | Pending | — |
