...
- [x] **Phase 6: Diagram-First Docs** - `/bgsd-user-eval` + Review Gate + Loop 2 page and `/bgsd-feedback` + CHANGELOG-into-PR page, GSD-Mintlify style, including the exact human-gated `--live` steps
