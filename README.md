...
[![version](https://img.shields.io/badge/version-0.5.1-informational.svg)](./bgsd/.claude-plugin/plugin.json)
[![tests](https://img.shields.io/badge/tests-43%20passing-brightgreen.svg)](#architecture-at-a-glance)
...
| `--fable` | Swap the top-tier model: use `claude-fable-5` everywhere the pipeline would use Opus (the Conductor included). Revert anytime by telling the Conductor ("drop fable" / "back to Opus"). |
